...
export function integrateGitalk(router) {
    ...
    const renderGitalk = () => {
        const gitalk = new Gitalk({
            clientID: '6e4e4ed2f1fdcf4a5abb', // GitHub Application Client ID
            clientSecret: 'a0b4c9bb3ff2ea5260fa1a179eb6e0b941661f42', // GitHub Application Client Secret
            // repo: 'comtest',      // 存放评论的仓库
            repo: 'blogComment', // 存放评论的仓库
            owner: 'freshhu', // 仓库的创建者，
            admin: ['freshhu'], // 如果仓库有多个人可以操作，那么在这里以数组形式写出
