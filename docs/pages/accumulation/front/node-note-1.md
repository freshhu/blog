...
- 使用url库
```js
let str = 'https://freshhu.github.io/blog/pages/hodgepodge/food-menu/food-menu-1.html';
...
getUrl('https://freshhu.github.io/blog/images/hodgepodge/food-menu/hspg.jpg', data=> {
