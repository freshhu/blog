...
如上两行代码运行结果为:![](/blog/images/basics/js/base-one-img3.png)
...
![](/blog/images/basics/js/base-one-img4.png)
...
![](/blog/images/basics/js/base-one-img5.png)
...
![](/blog/images/basics/js/base-one-img6.png)
...
- 子类使用super关键字访问父类的方法
  ...
  **注意:** 
  ...
  3. 如果子类想要继承父类的方法,同时在自己内部扩展自己的方法,利用super 调用父类的构造函数,super 必须在子类this之前调用
     ...
     ![](/blog/images/basics/js/base-one-img7.png)
