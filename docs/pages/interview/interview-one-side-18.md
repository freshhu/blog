...
[代码笔记](https://freshhu.github.io/blog_code/interview/interview-one-side/18.html)
...
- 场景
  ...
  ```
- 答案
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/对象深度比较.html)
  ```js
  const obj1 = {a:10, b:{x:100, y:200}}
  const obj2 = {a:10, b:{x:100, y:200}}
...
- 延伸
  ...
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/数组基本操作.html)
  ```js
  // 定义数组
...
- 答案
  ...
  - 是否是纯函数
    - slice是纯函数
    - splice不是纯函数
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/数组slice和splice的区别.html)
  ```js
  // 定义数组
  const arr = [10, 20, 30, 40]
...
- 答案
  - `[10, NaN, NaN]`
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/数组的map.html)
  ```js
  // 他实际上算是简写
...
- 延伸
  ...
  - call、apply、bind的应用
    - demo包含之前面试题
    - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/函数call和apply的区别.html)
    ```js
...
- 答案
  ...
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/事件代理.html)
  ```js
...
- 延伸
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/闭包.html)
  - 闭包与内存
  ```js
  /**
   * 闭包与内存
...
- 答案
  ...
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/阻止事件冒泡和默认行为.html)
  ```html
  <div id="div1">
...
- 答案
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/查找、添加、删除、移动DOM节点的方法.html)
  - 查找节点
    - 基本的查找
...
- 背景
  - dom操作非常消耗性能
- 答案
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/如何减少DOM操作.html)
  - 缓存dom查询结果
  ```html
  <div id="div1" class="container">
      <p>111</p>
...
- 答案
  ...
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/JSONP跨域原理.html)
  ```html
  <script>
...
- 答案
  ...
  - 函数声明会在代码执行前预加载，而函数表达式不会
    - 这个预加载和变量提升是一样的
    - 函数表达式没有变量提升
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/函数声明和函数表达式的区别.html)
  ```js
  /**
   * 函数声明
   */
...
- 答案
  ...
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/new Object()和Object.create()的区别.html)
  ```js
  const obj1 = {
    a: 10,
    b: 20,
...
### 8.4. 关于this的场景题
- [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/关于this的场景题.html)
- 场景
  ```js
  const User = {
    count: 1,
...
### 9.2. 关于作用域和自由变量的场景题
- [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/关于作用域和自由变量的场景题.html)
- 场景题1
  ```js
...
- 延伸
  ...
  - `+` => 表达式至少出现1次，相当于 {1,}
  - `*` => 表达式不出现或出现任意次，相当于 {0,}
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/正则.html)
  ```js
  // 邮政 - 6位数字
  // \d表示数字
  // {6}表示6位
...
- 考察内容
  - 考察原型、this、正则、字符串api
- 答案
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/手写字符串trim方法.html)
  ```js
...
### 10.3. 如何获取多个数字中的最大值
- 答案
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/如何获取多个数字中的最大值.html)
  ```js
  // 自己写一个方法
  function max() {
...
- 答案
  - 使用class继承
  - 使用prototype继承
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/如何用JS实现继承.html)
  ```js
  // 父类
  class People {
    constructor(name) {
...
- 答案
  ...
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/如何捕获JS程序中的异常.html)
  ```js
  /**
   * 使用try...catch...
   */
...
- 答案
  ...
  - 新的api => URLSearchParams
    - 很简单，但要考虑浏览器兼容问题
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/获取当前页面url的参数.html)
  ```js
  // 给当前地址添加参数
...
### 12.2. 将url参数解析为js对象
- 答案
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/将url参数解析为js对象.html)
  ```js
  // 给当前地址添加参数
  history.pushState("","","?a=123&b=666")
...
- 答案
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/手写数组flatern.html)
  ```js
  /**
   * 对于简单的二层结构拍平
   * 对于更深层次的数组，要是用递归
...
- 答案
  ...
  - 需要考虑计算效率
    - set不需要遍历，效率比较高
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/数组去重.html)
  ```js
...
### 13.2. 手写深拷贝
- 答案
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/手写深拷贝.html)
  ```js
  const deepClone = (obj = {})=> {
...
- 答案
  ...
  - [手写demo传送门](https://freshhu.github.io/blog_code/interview/interview-one-side/example/questions/介绍一下RAF.html)
  ```html
  <style type="text/css">
    #div1 {
      width: 100px;
